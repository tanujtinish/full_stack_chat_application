package com.tanuj.UserService.configuration;

import com.tanuj.UserService.services.UserDetailsServiceImpl;
...
public class SecurityAPIConfig {
  ...
  @Autowired
  private EntryPointForJWTSecurity entryPointForJWTSecurity;
